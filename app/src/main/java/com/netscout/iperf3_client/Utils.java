...
/**
 * Created by krisarmstrong on 3/5/18.
 */
...
public class Utils {
    ...
    public static String getProfileDatabaseFilePath(Context context,
                                                    String name) {
        return getMainDatabaseFolder(context)
                + getProfileDatabaseName(name);
    }
